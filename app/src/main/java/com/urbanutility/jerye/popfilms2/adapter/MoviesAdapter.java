...
import com.urbanutility.jerye.popfilms2.DetailedActivity;
...
//        http://image.tmdb.org/t/p/w185//nBNZadXqJSdt05SHLqgT0HuC5Gm.jpg
        ...
        Picasso.with(mContext).load(Utils.baseImageUrl + moviesList.get(position).getPosterPath()).into(holder.gridPoster);
    ...
    public void addMovies(Result result) {
        ...
        Picasso.with(mContext).load(Utils.baseImageUrl + result.getPosterPath()).fetch(this);
    }
